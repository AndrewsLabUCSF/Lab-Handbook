...
[Wynton Bioinformatics Open Data Resource](https://docpollard.org/resources/data/wynton-bioinformatics-open-data-resource/)
...
# Copy the contents of your key_pair.pub file to paste on GitHub (see below)
...
Click on “New SSH key” and paste the entire contents of key_pair.pub (including your email address associated with GitHub) into the new “Authentication Key”. Save this key.
...
Click on SSH. 
Copy the code in the box to use in your git clone command (see below).
