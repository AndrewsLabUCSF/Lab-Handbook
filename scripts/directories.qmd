...
To push empty directories while ensuring that large or sensitive files are not inadvertently made available on GitHub, you can add the following `.gitignore` file. This is useful to include in `resources` or `data` directories.
...
- `docs` contains documentation files such as data dictionaries
